...
// PostWidget functional component
const PostWidget = ({
  postId,
  postUserId,
  name,
  ...
  const isLiked = likes && loggedInUserId in likes;
  ...
  return (
    ...
    <WidgetWrapper m="2rem 0">
      ...
      {/* Render the like, comment, and share icons */}
      <FlexBetween mt="0.25rem">
        <FlexBetween gap="1rem">
          {/* Render the like button */}
          <FlexBetween gap="0.3rem">
            <IconButton onClick={patchLike}>
              {/* Render the filled heart icon if post is liked, otherwise, render the outlined heart */}
              {isLiked ? (
      ...
      {/* Render the comments section if comments are visible */}
      {isComments && (
        <Box mt="0.5rem">
          ...
          {/* Render a divider between comments */}
          <Divider />
        </Box>
      )}
    </WidgetWrapper>
